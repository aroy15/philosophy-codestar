...
function philosophy_google_map($attributes){
    ...
    $map = <<<EOD
        <div>
            <div>
            <iframe 
                width="{$params['width']}" height="{$params['height']}" style="border:0;"
                src="https://www.google.com/maps?q={$params['place']}&t=&z={$params['zoom']}&ie=UTF8&iwloc=&output=embed"
