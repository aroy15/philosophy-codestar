        ...
        <article class="row format-standard">
            ...
            <div class="col-full s-content__main">
                ...
                <?php 
                    ...
                    echo esc_html($philosophy_page_meta['page-heading']);
                    echo "<br>";
                    echo esc_html($philosophy_page_meta['page-teaser']);
                    echo "<br><br>";
                    if($philosophy_page_meta['is-favorite-extra']){
                        echo esc_html($philosophy_page_meta['is-favorite-text']);
                    }
                ?>
