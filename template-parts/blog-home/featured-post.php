...
while($philosophy_fp->have_posts()){
    ...
    $category = $categories[mt_rand(0, count($categories)-1)];// for random
    $post_data[] = array(
        "title" => get_the_title(),
        ...
        "cat" => $category->name,  // normal: $categories[0]->name,
        ...
        <div class="featured">
            <div class="featured__column featured__column--big">
                <div class="entry" style="background-image:url('<?php echo esc_url($post_data[0]['thumbnail']);?>');">
                    ...
                    <div class="entry__content">
                        <span class="entry__category"><a href="<?php echo esc_url($post_data[0]['cat_url']);?>"><?php echo esc_html($post_data[0]['cat']);?></a></span>
            ...
            <div class="featured__column featured__column--small">
                ...
                <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']);?>');">
                    ...
                    <div class="entry__content">
                        <span class="entry__category"><a href="<?php echo esc_url($post_data[$i]['cat_url']);?>"><?php echo esc_html($post_data[$i]['cat']);?></a></span>
